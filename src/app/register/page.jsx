...
//             <form action="">
//                 <input className="bg-white text-black" type="email" name="Email" placeholder="Email.."/>
//                 <input className="bg-white text-black" type="password" name="Password" placeholder="Password.."/>
//                 <button clas type="submit">Login</button>
//             </form>
//         </section>
//     )
// }
